...
class CourseView(forms.ModelForm):
    class Meta:
        model = Course
        fields = ["course_id", "course_name", "course_cate_id", "instructor_id", "course_overview", "course_price", "course_image", "course_duration", "course_lecture", "course_quiz", "course_percent_pass", "course_max_retake", "course_long_overview", "course_what_learn", "course_video"]
